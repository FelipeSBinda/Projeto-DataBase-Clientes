...
echo "<div class='col-sm'> <a href='?pagina=novo'>";
		...
		foreach ($cadastros as $cadastro) {
			...
			echo "<div class='col-sm'> <a href='?pagina=editar&cadastro=" . $cadastro["telefone"] . "'>";
            include "assets/icons/resume.svg";
            echo "<div class='col-sm'> <a href='?pagina=editar&cadastro=" . $cadastro["email"] . "'>";
            include "assets/icons/resume.svg";
            echo "<div class='col-sm'> <a href='?pagina=editar&cadastro=" . $cadastro["foto"] . "'>";
			include "assets/icons/resume.svg";
